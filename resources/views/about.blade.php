...
<div class="flex-grow pt-16">
    <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p class="abt">
            ...
            a student juggling multiple assignments, or someone who just loves staying organized, TaskPro is here to help.
            <br><br>
            With TaskPro, you can easily create, edit, and prioritize tasks, set deadlines and reminders,
            and even categorize tasks into different projects or lists. Our collaborative features allow
            you to share lists with colleagues, friends, or family members, ensuring everyone stays on the same page.
            <br><br>
            Additionally, TaskPro provides insightful analytics to track your progress and identify areas for improvement.
            The sleek and responsive design ensures you can access your tasks from any device, be it a desktop, tablet, or smartphone.
            <br><br>
            Sign up today and experience the power of seamless task management with TaskPro. Join our community
